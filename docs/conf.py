...
"""
web-fragments documentation build configuration file.
...
version = web_fragments.__version__
# The full version, including alpha/beta/rc tags.
release = web_fragments.__version__
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/web-fragments",
...
#
# html_title = 'web-fragments v0.1.0'
...
htmlhelp_basename = 'web-fragments-doc'
...
latex_documents = [
    (master_doc, 'web-fragments.tex', 'web-fragments Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'web-fragments', 'web-fragments Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'web-fragments', 'web-fragments Documentation',
     author, 'web-fragments', 'Web fragments',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'web_fragments'),
                os.path.join(root_path, 'web_fragments/migrations')])
